...
public class Ex2 {
	...
	public static void main(String[] args) {
		...
		Date d1 = new Date();
		System.out.println(d1.toString()); // toString() 생략 가능
		
		// 생성자에 long타입 값을 전달 시 해당 값에 맞는 Date 객체 생성됨
		//Date d2 = new Date(0); // 1970년 1월 1일 09시 기준 설정
		Date d2 = new Date(1698195300000L);
		...
		if(differentDate / 1000 / 60 / 60 / 24 > 0) {
			System.out.println(differentDate / 1000 / 60 / 60 / 24 + "일 남았습니다");
		} else if(differentDate / 1000 / 60 / 60 / 24 < 0) {
