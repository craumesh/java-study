...
public class Ex1 {
	...
	public static void main(String[] args) {
		 ...
		 * 	=> FileOutpuStream, FileWriter, BufferedOutputStream, BufferedWriter 등
		 * 
		 * [ 바이트 단위 스트림과 문자 단위 스트림 ]
		 * 1. byte 기반(단위) 스트림
		 * 	=> 그림, 사진, 영상 등 바이너리(Binary) 데이터를 입출력
		 * 	=> InputStream, OutputSteam 을 최상위 클래스로 두고
		 ...
		 * 	=> FileInputSteam, FileOutputStream, FileReader, FileWriter 등
		 * 
		 * 2. 보조 스트림
		 ...
		 * 	=> 프로그램이 시작도리 때 생성되므로 따로 만들 필요가 없음
		 * 	=> 표준 입력 장치 : 키보드
		 * 	=> 표준 출력 장치 : 모니터
...
//			System.out.println("입력 데이터를 문자 변환 : "+(char)n);
//		} catch (IOException e) {
...
//		}
		 ...
		 * 	자원이 반환되지 않으면 반복적인 자원 요청으로 인행 자원이 고갈되어
