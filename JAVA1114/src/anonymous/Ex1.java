...
public class Ex1 {
	...
	public static void main(String[] args) {
		 ...
		 * - 익명 객체를 만들기 위해서는 어떤 클래스를 상속하거나 인터페이스를 구현해야한다
...
//		np.work(); // 참조영역의 축소로 접근 불가
		
		System.out.println("----------------------------------------------------------");
		
		NormalInterface ni = new NormalChild2();
		ni.run(); // 구현 클래스의 구현 메서드를 호출
...
//		np2.run();
		...
		uac.p.wake();
//		System.out.println(uac.p.childVar);
//		uac.p.childMethod();
		// => 접근불가
