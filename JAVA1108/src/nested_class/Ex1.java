...
public class Ex1 {
	...
	public static void main(String[] args) {
		 ...
		 * 	외부에서는 불필요한 관계 클래스를 감춤으로서 코드의 복잡성을 줄일 수 있는 장점
		 ...
		 * - 외부클래스(Outer Class)와 내부클래스(Inner Class)로 구분
...
//		static int innerNum2 = 200; // 정적 멤버 선언 불가
...
//		public static void innerStaticMethod() {} // => 정적 메서드도 선언 불가
	}
	...
	static class StaticInner {
		...
		static int innerStaticNum = 20; // 정적 멤버 선언 가능
		
		public void innerMethod() {
//			System.out.println("외부 클래스의 인스턴스 멤버변수 num = " + num);
			// => 정적 클래스 생성 시점에서 외부 클래스의 일반 인스턴스 멤버는
			// 		생성되지 않은 상태이므로 접근 불가
//			method2();
...
//			System.out.println("내부클래스의 인스턴스 멤버변수 innerNum = " + innerNum);
			System.out.println("내부클래스의 인스턴스 멤버변수 innerStaticNum = " + innerStaticNum);
		}
	}	
}
