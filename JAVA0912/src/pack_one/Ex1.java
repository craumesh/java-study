...
public class Ex1 {
	...
	public static void main(String[] args) {
		 ...
		 * 		= 같은 이름의 클래스는 같은 패키지에 위치할 수 없음
		 * - 자바에서 패키지를 생성하면 실제 폴더 구조로 된 패키지가 생성됨
		 * - 특정 클래스 파일은 하나의 패키지에만 소속될 수 있음
		...
		// import 문을 통해 포함 시키더라도 각 클래스 구분을 위해
