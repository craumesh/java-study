...
public class Ex2 {
	...
	public static void main(String[] args) {
		 ...
		 * - 클래스가 메모리에 로딩될 때 static 벼눗와 함께 메모리에 로딩되므로
		 * 	인스턴스 생성과는 무관함
...
class StaticMethod {
	...
	public void normalMethod() {
		...
		// 일반 메서드에서는 정적 메서드 호출 가능
		staticMethod();
	}
	
	// 정적 메서드 staticMethod() 메서드 정의 - 파라미터, 리턴값 없음
	public static void staticMethod() {
		...
		// static 메서드에서 일반 메서드 호출 불가 - 변수와 동일 이유
		//normalMethod();
	}
	...
	// 정적 변수 staticVar 에 대한 Setter 정의
