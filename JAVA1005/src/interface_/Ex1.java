...
public class Ex1 {
	...
	public static void main(String[] args) {
		 ...
		 * 	=> implemets 키워드 뒤에 복수개의 인터페이스 지정 가능
		 * - 인터페이스끼리 상속받을 경우 implements가 아닌 extends로 상속
		 * 	=> 추상메서드는 구현(implements) 하지 못함
		 * 
		 * < 인터페이스 정의 기본 문법 >
...
interface MyExInterface {
	...
	public static final int NUM1 = 999999999;
	int NUM2 = 1000000000; // public static final 생략되어 있음
	
	// 인터페이스는 생성자를 가질 수 없다, 따라서 인터페이스의 모든 상수는 선언 시 초기화 해야된다
...
abstract class MyClass {
	...
	public static final int NUM1 = 999999999; //상수
	public int NUM2 = 999999999; // 인스턴스 멤버변수
