...
public class Ex4 {
	...
	public static void main(String[] args) {
		...
		System.out.println(Integer.min(num1, num2)); // 기본 데이터 타입
		System.out.println(Integer.min(n1, n2));	// Wrapper 클래스 타입 모두 사용
		...
		System.out.println("소문자 변환 데이터 : " + Character.toLowerCase(ch));
		
		
		System.out.println("-------------------------------------------------------");
		
		// 입력받은 문자 ch 에 대한 대문자, 소문자, 숫자, 기타문자 판별
		// => 대문자 : 문자 ch가 'A'(65) 이상이고, 문자 ch가 '2(92) 이하
		if(ch >= 'A' && ch <= 'Z') {
